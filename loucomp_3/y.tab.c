...
{
       0,    43,    43,    46,    58,    60,    61,    63,    70,    86,
      91,    97,   105,   116,   117,   125,   138,   140,   148,   160,
     169,   182,   184,   197,   199,   200,   201,   202,   203,   205,
     206,   208,   213,   220,   226,   230,   236,   242,   244,   249,
     259,   266,   268,   273,   278,   283,   288,   293,   299,   306,
     308,   313,   319,   325,   327,   332,   338,   340,   341,   342,
     348,   355,   356,   358,   371
};
#endif
...
static const char *const yytname[] =
{
  ...
  "RETURN", "INT", "VOID", "ID", "NUM", "PLUS", "MINUS", "TIMES", "OVER",
  "LT", "LE", "GT", "GE", "EQ", "NE", "ASSIGN", "LPAREN", "RPAREN",
  "LBRACKET", "RBRACKET", "LBRACE", "RBRACE", "SEMI", "COMMA", "ENDFILE",
  "ERROR", "$accept", "program", "decl_list", "decl", "var_decl", "type",
  "identifier", "func_decl", "params", "param_list", "param", "compound",
  "local_decls", "stmt_list", "stmt", "exp_stmt", "if_stmt", "while_stmt",
  "return_stmt", "exp", "var", "simple_exp", "relop", "add_exp", "addop",
  "term", "mulop", "factor", "call", "args", "arg_list", YY_NULLPTR
};
...
{
      53,   -90,   -90,     3,    53,   -90,   -90,     7,   -90,   -90,
     -90,   -90,    17,    61,    13,   -90,     6,     7,    14,    22,
     -90,    31,    48,    49,    53,    50,    51,   -90,   -90,   -90,
     -90,   -90,    53,   -90,     7,     4,    25,    55,    58,    26,
     -90,    33,   -90,   -90,   -16,   -90,   -90,   -90,   -90,   -90,
     -90,    54,    60,   -90,    47,    57,   -90,   -90,    33,    33,
     -90,    56,    63,    33,    33,   -90,    33,   -90,   -90,   -90,
     -90,   -90,   -90,   -90,   -90,    33,    33,   -90,   -90,    33,
      64,    65,   -90,   -90,   -90,    66,    67,    68,   -90,   -90,
      62,    57,   -90,    12,    12,   -90,    33,   -90,    75,   -90,
     -90,    12,   -90
};
...
static const yytype_int8 yydefact[] =
{
       ...
       3,    11,     0,     0,     0,     7,    10,     0,     0,    13,
      16,     0,    17,     0,     0,     0,     0,    21,    12,    15,
       8,    18,    23,    20,     0,     0,     0,     0,     0,     0,
      59,     0,    19,    30,    38,    25,    22,    24,    26,    27,
      28,     0,    57,    37,    41,    49,    53,    58,     0,     0,
      34,     0,     0,    62,     0,    29,     0,    50,    51,    43,
      42,    44,    45,    46,    47,     0,     0,    54,    55,     0,
       0,     0,    35,    56,    64,     0,    61,     0,    36,    57,
...
{
     -90,   -90,   -90,    79,    59,    20,    -6,   -90,   -90,   -90,
      70,    69,   -90,   -90,   -89,   -90,   -90,   -90,   -90,   -39,
     -29,   -90,   -90,    10,   -90,    19,   -90,    11,   -90,   -90,
     -90
};
...
{
      61,    12,    62,     9,    98,    99,    63,    37,    64,    38,
      39,    22,   102,    11,    40,    37,    11,    38,    39,    80,
      81,    11,    40,    21,    84,    87,    41,    88,    36,   -14,
      27,    42,    43,    17,    41,    11,    40,    23,    27,    13,
      43,    14,    11,    40,    17,    15,    89,    89,    41,    14,
      89,    24,    34,    15,    60,    41,    25,   100,    67,    68,
       1,     2,    69,    70,    71,    72,    73,    74,     1,    16,
      77,    78,    26,    67,    68,    27,    31,    58,    30,   101,
      59,    66,    65,    10,    82,    90,    83,    93,    94,    95,
      92,    33,    28,    97,    29,    91,    96
};

static const yytype_int8 yycheck[] =
{
      39,     7,    41,     0,    93,    94,    22,     3,    24,     5,
       6,    17,   101,     9,    10,     3,     9,     5,     6,    58,
      59,     9,    10,    10,    63,    64,    22,    66,    34,    23,
      26,    27,    28,    13,    22,     9,    10,    23,    26,    22,
      28,    24,     9,    10,    24,    28,    75,    76,    22,    24,
      79,    29,    32,    28,    28,    22,    25,    96,    11,    12,
       7,     8,    15,    16,    17,    18,    19,    20,     7,     8,
      13,    14,    24,    11,    12,    26,    25,    22,    28,     4,
      22,    21,    28,     4,    28,    75,    23,    23,    23,    23,
      79,    32,    23,    25,    24,    76,    29
};
...
{
       0,     7,     8,    33,    34,    35,    36,    37,    39,     0,
      35,     9,    38,    22,    24,    28,     8,    37,    40,    41,
      42,    10,    38,    23,    29,    25,    24,    26,    43,    42,
      28,    25,    44,    36,    37,    45,    38,     3,     5,     6,
      10,    22,    27,    28,    38,    43,    46,    47,    48,    49,
      50,    51,    52,    53,    55,    57,    59,    60,    22,    22,
      28,    51,    51,    22,    24,    28,    21,    11,    12,    15,
      16,    17,    18,    19,    20,    54,    56,    13,    14,    58,
      51,    51,    28,    23,    51,    61,    62,    51,    51,    52,
      55,    57,    59,    23,    23,    23,    29,    25,    46,    46,
      51,     4,    46
};
...
#line 1341 "y.tab.c"
  ...
  case 7: /* var_decl: type identifier SEMI  */
#line 64 "cminus.y"
                {
                  TreeNode *t = newDeclNode(VarDK);
                  t->attr.name = copyString(yyvsp[-1]->attr.name);
                  t->type = yyvsp[-2]->type;
                  yyval = t;
                }
#line 1352 "y.tab.c"
  ...
  case 8: /* var_decl: type identifier LBRACKET NUM RBRACKET SEMI  */
#line 71 "cminus.y"
                {
                  TreeNode *t = newDeclNode(VarDK);
                  t->attr.name = copyString(yyvsp[-4]->attr.name);
                  t->type = yyvsp[-5]->type+2;
                  /*
                  t->isArray = TRUE;
                  */
...
#line 1400 "y.tab.c"
  ...
  case 12: /* func_decl: type identifier LPAREN params RPAREN compound  */
#line 106 "cminus.y"
                {
...
#line 141 "cminus.y"
                {
                  TreeNode *t = newExpNode(ParamK);
                  t->attr.name = copyString(yyvsp[0]->attr.name);
                  t->type = yyvsp[-1]->type;
...
#line 1466 "y.tab.c"
  ...
  case 18: /* param: type identifier LBRACKET RBRACKET  */
#line 149 "cminus.y"
                {
                  TreeNode *t = newExpNode(ParamK);
                  t->attr.name = copyString(yyvsp[-2]->attr.name);
                  t->type = yyvsp[-3]->type+2;
                  /*
                  t->isArray = TRUE;
                  */
...
#line 1481 "y.tab.c"
  ...
  case 19: /* compound: LBRACE local_decls stmt_list RBRACE  */
#line 161 "cminus.y"
                {
...
#line 1493 "y.tab.c"
  ...
  case 20: /* local_decls: local_decls var_decl  */
#line 170 "cminus.y"
                {
                  YYSTYPE t = yyvsp[-1];
                  if (t != NULL)
...
#line 1651 "y.tab.c"
  ...
  case 39: /* var: identifier LBRACKET exp RBRACKET  */
#line 250 "cminus.y"
                {
                  yyval = newExpNode(VarK);
...
#line 1831 "y.tab.c"
  ...
  case 60: /* call: identifier LPAREN args RPAREN  */
#line 349 "cminus.y"
              {
